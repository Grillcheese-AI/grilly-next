...
/// Push constants for vsa-inference.glsl.
...
//
// Two-shader pipeline:
//   1. Transformer (vsa-inference): XNOR(state, weights) -> predicted
...
// After the first token, the 2.5 MB logic matrix is pinned in L2 cache.
...
private:
    ...
    // Logic weights (persistent BDA buffer)
